 ...
 */
public class ModifyAgeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new TitleBuilder(this).setTitleText(getString(R.string.modify_age)).setLeftImage(R.drawable.back).setLeftClickListener(new View.OnClickListener() {
            @Override
        ...
        editText.setText(App.getUser().getUserAge());
    }
        ...
        call.enqueue(new Callback<Code>() {
            ...
            public void onResponse(Call<Code> call, Response<Code> response) {
                if (response.isSuccess()) {
                    ...
                    if (body.getCode() == 1) {
                        ToastUtils.showShort(ModifyAgeActivity.this, body.getMessage());
                    }
                }
            }
